...
public class ProductService {
	...
	private void copyDtoToEntity(ProductDTO dto, Product entity) {
		...
		entity.getCategories().clear(); //para garantir que somente serão copiadas as categorias que vieram no dto - limpa o conjunto de categorias que poderiam estar na entidade
